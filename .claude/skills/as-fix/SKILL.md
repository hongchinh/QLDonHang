...
3. Use `AskUserQuestion` to confirm the handoff target.
...
2. Collect/confirm minimum bug report fields:
   ...
   - Impact/severity
3. Read project context when relevant: `CLAUDE.md`, `docs/SUMMARY.md`, and code in the affected area.
...
- Do not guess when key context is missing; ask via `AskUserQuestion`.
